...
const DiscoveryInfo = () => {
  return (
    <div className="md:mt-72 mt-20 md:gap-56 gap-10 flex flex-col md:px-20 relative">
      <img src={NumberBg} alt="number" className="absolute -z-20 top-[20rem] hidden md:block" />
