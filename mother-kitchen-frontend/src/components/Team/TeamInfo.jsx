    ...
    <div>
      ...
      <BorderDiv className="bg-[#D07D41] p-10">
        <div className="flex justify-center mt-5">
          <img src={TeamHeading} alt="heading" className="h-20 -mt-5 absolute -z-10" />
          <h3 className="text-white font-semibold font-lexend text-center text-3xl drop-shadow-3xl">Executive Team</h3>
        </div>
        <div className="flex mt-20 mx-auto gap-24 w-[50vw]">
          <div className="flex flex-col items-center text-white font-gluten">
            <ImageBox image={Shivani} />
            <h5 className="text-2xl mt-4">SUNIL CHAUHAN</h5>
            <p className="my-3">CO-FOUNDER</p>
        ...
        <div className="flex justify-start mt-10">
          <img src={TeamHeading} alt="heading" className="h-20 -mt-5 absolute -z-10" />
          <h3 className="text-white font-semibold font-lexend text-center text-3xl drop-shadow-3xl ml-5">
            Advisory Board
          </h3>
        </div>
        <div className="grid grid-cols-4 gap-x-24 gap-y-10 m-10">
