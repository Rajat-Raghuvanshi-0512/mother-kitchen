  ...
  return (
    <section>
      ...
      <div className="relative">
        <div className="md:pt-28 pb-20 [&>*:nth-child(odd)]:translate-y-20 flex w-[300%] gap-10 overflow-hidden select-none -left-10">
        ...
        <div className=" pb-20 [&>*:nth-child(odd)]:translate-y-20 flex w-[300%] gap-10 overflow-hidden select-none -left-10">
          {reviews.map((review, idx) => (
            <ReviewCard {...review} key={review.name + idx} />
          ))}
          {reviews.map((review, idx) => (
