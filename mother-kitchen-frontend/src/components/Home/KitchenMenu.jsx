...
const KithchenMenuSm = () => {
  return (
    <section className="py-24">
      <div className="border-4 border-r-8 border-b-8 border-black rounded-xl bg-[#7B1238]">
        ...
        <div className="grid grid-cols-3 pb-7">
          <div className="p-3 flex flex-col items-center">
            ...
            <Button className="font-bold !bg-[#41041A] hover:!bg-[#560c27] flex items-center gap-2">
