...
const Brand = () => {
  return (
    <div>
      <BorderDiv className="mx-24 bg-[#516AC0] p-10">
        <h4 className=" mx-auto text-center font-gluten text-[8px] text-white md:w-[80%] md:text-xl">
        ...
        <div className="grid grid-cols-2 gap-5 md:m-20 md:grid-cols-3 md:gap-x-24 md:gap-y-14">
